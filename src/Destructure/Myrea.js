...
export const Myrea = () => {
  ...
  useEffect(()=> {
    const fetch = async()=>{
     ...
     console.log(res.data.reactEmployee);
     setEmployee(res.data.reactEmployee);
     console.log(res.data.reactEmployeeSalarySum);
     setAmount(res.data.reactEmployeeSalarySum);
    }
