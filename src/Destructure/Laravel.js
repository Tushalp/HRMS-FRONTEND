...
export const Laravel = () => {
    ...
    const [url, setUrl] = useState(
        "https://hrms-backend-tqlm.onrender.com/api/admin/laravelEmployeeData"
      );
      ...
      useEffect(()=> {
        const fetch = async()=>{
         ...
         console.log(res.data.laravelEmployee);
         setEmployee(res.data.laravelEmployee);
         console.log(res.data.laravelEmployeeSalarySum);
         setAmount(res.data.laravelEmployeeSalarySum);
        }
