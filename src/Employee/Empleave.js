  ...
  return (
    <div className="Dashpage-main">
      <div className="dashbord-second">
        ...
        <Link
          to={`/dashbordemployee/${id}/empapplyleav/${id}`}
              ...
              {employee.map((e) => {
                return (
                  <tr className="employeetr">
                    ...
                    <td className="employeetd emp">
                      <span className="employee-btn"><p className={ e.status==='pending' ? 'pending': e.status==='approved' ? "approver" : "reject"}>{e.status}</p></span>
                    </td>
                  </tr>
                );
              })}
